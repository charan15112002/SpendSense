...
|---|---|---|---|---|---|---|
| COV-01 | Distribution architecture and permission split | S4-M1, S4-M2, S4-M12, S5-UX10 | Section 4, Section 5 | Not started | Not started | Play vs sideload flavors must stay separate |
| COV-02 | Core transaction model and storage schema | S4-M3, S4-M4, S4-M5 | Section 4 | Not started | Not started | 6-axis model is canonical |
| COV-03 | Detection, duplicate filtering, and lifecycle handling | S2-P01, S2-P04, S2-P13, S4-M3 | Section 2, Section 4 | Not started | Not started | Includes failed, reversed, pending logic |
| COV-04 | Source trust, quarantine, and fake defense | S2-P12, S4-M9, S5-UX7 | Section 2, Section 4, Section 5 | Not started | Not started | Suspicious items must stay outside totals |
